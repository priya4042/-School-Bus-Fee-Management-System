...
import { Bus, Shield, Eye, EyeOff, Lock, Mail } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-zinc-50 dark:bg-zinc-950">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-500 text-sm mt-1 text-center">Enterprise management access only</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-zinc-100 dark:border-zinc-800 text-center space-y-4">
          <div className="flex flex-col gap-2">
            ...
            >
              New Admin? Register with Setup Key
            </button>
          </div>
          <button 
            onClick={() => navigate('/')}
