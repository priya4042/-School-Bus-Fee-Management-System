              ...
              <tbody className="divide-y divide-slate-50">
                {filteredStudents.map((student) => (
                  <tr key={student.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-8 py-5">
                      <p className="text-xs font-bold text-slate-700">{student.parent?.full_name || 'Unassigned'}</p>
                      <p className="text-[10px] text-slate-400 font-bold">{student.parent?.phone_number || ''}</p>
                    </td>
                    <td className="px-8 py-5">
