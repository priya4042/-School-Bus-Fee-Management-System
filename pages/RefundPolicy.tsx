      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Meena Devi – Bus Transport Service operates a digital platform that enables parents to pay school bus transportation fees online.
          ...
          <section>
            ...
            <p>
              Meena Devi – Bus Transport Service reserves the right to modify this Refund & Cancellation Policy at any time.
        ...
        <div className="mt-10 pt-6 border-t border-gray-200">
          ...
          <p className="text-sm text-gray-500 mt-3">&copy; {new Date().getFullYear()} Meena Devi – Bus Transport Service. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
