  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8 md:p-20">
      <div className="max-w-4xl mx-auto bg-white rounded-[2.5rem] p-10 md:p-20 shadow-xl">
        <h1 className="text-4xl font-black text-slate-800 mb-8 tracking-tighter">Privacy Policy</h1>
        <p className="text-slate-500 mb-6 font-bold uppercase text-[10px] tracking-widest">Last Updated: February 2026</p>
        
        <div className="space-y-8 text-slate-600 leading-relaxed">
          <section>
            <h2 className="text-xl font-black text-slate-800 mb-4 tracking-tight">1. Information Collection</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-slate-800 mb-4 tracking-tight">2. Location Data</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-slate-800 mb-4 tracking-tight">3. Data Security</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-slate-800 mb-4 tracking-tight">4. Account Deletion</h2>
