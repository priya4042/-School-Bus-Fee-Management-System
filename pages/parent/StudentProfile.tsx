  ...
  return (
    <div className="space-y-4 md:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-6">
        <div>
          <h1 className="text-xl md:text-4xl font-black text-slate-900 tracking-tight">Student Profile</h1>
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-3 md:items-center">
          {students.length > 1 && (
            <div className="flex gap-1.5 p-1 md:p-1.5 bg-slate-100 rounded-xl md:rounded-2xl border border-slate-200/50 overflow-x-auto scrollbar-hide">
              {students.map((s) => (
                <button
                  key={s.id}
                  onClick={() => setSelectedStudent(s)}
                  className={`flex-shrink-0 px-3 md:px-6 py-2 md:py-3 rounded-lg md:rounded-xl text-[9px] font-black uppercase tracking-widest transition-all active:scale-95 ${
                ...
                >
                  ...
                  <span className="block text-[8px] font-bold tracking-normal normal-case mt-0.5 md:mt-1 opacity-80">
          ...
          <button
            ...
            className="bg-primary text-white px-4 md:px-6 py-3 rounded-xl md:rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/20 hover:bg-blue-800 active:scale-95 transition-all flex items-center justify-center gap-2"
          >
